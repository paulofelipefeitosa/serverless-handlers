...
pure_startup <- read_startup("python_startup_nobpftrace.csv")
...
pure_latency <- read_latency("python_startup_nobpftrace.csv")
...
pure_servicetime <- read_servicetime("python_startup_nobpftrace.csv")
...
ggsave("python_noop_servicetime_ecdf_cmp.png")
...
ggsave("python_thumb_servicetime_ecdf_cmp.png")
```
...
pure_bpftrace_startup <- read.csv("new_startup_bpftrace.csv") %>% 
...
ggplot(perc_bpftrace_startup) +
  facet_grid(App~Runtime) +
  geom_bar(aes(y = med, 
               x = factor(Technique, c("Prebaking Warm", "Prebaking", "Vanilla")), 
