...
nocriu_nobpf_nowarm_python_noop <- read.csv("python/server-http-handler-python-no-criu-noop-1567456446-300-300---.csv")
...
criu_nobpf_nowarm_python_noop <- read.csv("python/server-http-handler-python-criu-noop-1567464036-300-300---.csv")
...
criu_nobpf_warm_python_noop <- read.csv("python/server-http-handler-python-criu-noop-1567459420-300-300-YES--.csv")
...
nocriu_nobpf_nowarm_python_thumb <- read.csv("python/server-http-handler-python-no-criu-thumbnailator-1567456751-300-300---.csv")
...
criu_nobpf_nowarm_python_thumb <- read.csv("python/server-http-handler-python-criu-thumbnailator-1567464743-300-300---.csv")
...
criu_nobpf_warm_python_thumb <- read.csv("python/server-http-handler-python-criu-thumbnailator-1567460421-300-300-YES--.csv")
...
write.csv(nobpf_startup, 
  file = "python_startup_nobpftrace.csv",
  row.names = FALSE)
```
...
criu_bpf_nowarm_python_noop <- read.csv("python/server-http-handler-python-criu-noop-1567468049-300-2---YES.csv")
...
criu_bpf_nowarm_python_thumb <- read.csv("python/server-http-handler-python-criu-thumbnailator-1567469322-300-2---YES.csv")
