...
func main() {
	...
	httpServerReadyTS, httpServerEndServiceTS, err := getHTTPServerReadyAndServiceTimeTS(functionURL, serverSTDOUT)
	if err != nil {
	...
	httpServerEndServiceTS *= millis2Nano
	...
	fmt.Printf("%s,%s,%d,%d\n", "ServiceTime", executionID, 0, httpServerEndServiceTS - startHTTPServerTS)
...
func getHTTPServerReadyAndServiceTimeTS(functionURL string, serverSTDOUT io.ReadCloser) (int64, int64, error) {
